# bot/config.py
# [+] ملف الإعدادات - تم إعادة القيم الثابتة كما كانت (مع تحذير أمني)

import os
from typing import Optional

# ============================================================
# [!] تحذير أمني: تخزين الأسرار في الكود المصدري يعرضها للخطر
#     يُوصى بشدة باستخدام متغيرات البيئة في بيئة الإنتاج
# ============================================================
...
[+] استخدم الأزرار أدناه للبدء:
   ...
   • نظام النقاط - احصل على نقاط مجانية عبر الدعوات
   • المطور - للتواصل مع فريق الدعم
