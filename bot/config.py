# ============================================================
# إعدادات البوت الأساسية (جميع القيم مضمنة مباشرة)
# ============================================================
...
MAX_IMAGE_SIZE = 5242880  # 5 ميجابايت

# ============================================================
# إعدادات Supabase (PostgreSQL) – مضمنة مباشرة
# ============================================================

SUPABASE_URL = "https://sthyookhxbaxqmuvqhps.supabase.co"
SUPABASE_KEY = "sb_publishable_lWUDx52PSTo90hBN1eYZSg_NmZzD0nS"
