...
class AutoPostBot:
    ...
    def setup_flask_routes(self):
        ...
        def health():
            active_users = len(self.auto_poster.active_posts) if self.auto_poster else 0
            return jsonify({
                "status": "healthy", 
    ...
    async def show_main_menu(self, event):
        ...
        is_posting = self.auto_poster and event.sender_id in self.auto_poster.active_posts
...
اطلب من 5 أشخاص استخدام هذا الرابط وتفعيل البوت."""
    ...
    async def ban_user_handler(self, event, target_id):
        ...
        if self.auto_poster and target_id in self.auto_poster.active_posts:
    ...
    async def start(self):
        ...
        logger.info("📡 Web server is listening for webhook requests")
